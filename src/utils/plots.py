...
def plot_loss(epochs, train_losses, val_losses, save_pth: str):
    ...
    plt.loglog(epochs, train_losses, label="train")
    plt.loglog(epochs, val_losses, label="val")
    plt.legend()
...
def plot_accuracy(epochs, train_accs, val_accs, save_pth: str):
    plt.figure(figsize=(9, 9))
    plt.loglog(epochs, train_accs, label="train")
    plt.loglog(epochs, val_accs, label="val")
    plt.legend()
